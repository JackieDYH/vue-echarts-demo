 ...
 * @LastEditTime: 2023-09-25 10:26:45
 * @LastEditors: Jackie
 * @Description: file content
 * @FilePath: /vue-echarts-demo/src/components/LineVolumeChart/index.vue
 * @version: 
-->
<template>
  ...
  methods: {
    ...
    setOption() {
      this.chart.setOption(
        getOption(this.data, this.name, this.period, this.unit),
        true
      );
    },
    resize() {

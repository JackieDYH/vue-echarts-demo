 ...
 * @LastEditTime: 2023-09-25 10:26:37
 * @LastEditors: Jackie
 * @Description: file content
 * @FilePath: /vue-echarts-demo/src/components/LineBarChart/index.vue
 * @version: 
-->
<template>
...
export default {
  ...
  methods: {
    ...
    setOption() {
      this.chart.setOption(getOption(this.data, this.name, this.period), true);
    },
    resize() {
